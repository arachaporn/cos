...
<body>
		...
		<tr>			
			<td style="width:95%;">
				...
				?>
					...
					<td style="padding:1.5% 0 0 2%;vertical-align:top;"><?php if($rs_com_cate['id_com_cat']==$rs['id_com_cat']){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?>
						<?php if($rs_com_cate['id_com_cat']==$rs['id_com_cat']){$style_com_cate='<span style="color:#0079FC;">';}else{$style_com_cate='';}echo $style_com_cate.$rs_com_cate['title']?></td>
				...
				?>
					<tr>
						...
						<td style="padding:1.5% 0 0 2%;"><?php if($rs['id_com_cat']==-1){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?>
							อื่น ๆ ระบุ
		...
		<tr>
			...
			<td style="padding:0.5% 0 0 0;">
				<table style="width:100%;" cellpadding="0" cellspacing="0">
					...
					?>
						<td style="padding:1.5% 0 0 0;width:33.33%;"><?php if($rs['id_type_product']==$rs_type_product['id_npd_type_product']){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?>
						<?php if($rs['id_type_product']==$rs_type_product['id_npd_type_product']){$style_type_product='<span style="color:#0079FC;">';}else{$style_type_product='';}echo $style_type_product.$rs_type_product['npd_title'].'&nbsp;&nbsp;&nbsp;'?>
						</td>
	...
	<table style="width:100%;text-align:left;border-left:1px solid #000;border-right:1px solid #000;border-bottom:1px solid #000;" cellpadding="0" cellspacing="0">
		...
		?>
		<tr>
			<td style="padding:0 0 0 3%;font-size:0.9em;border-right:1px solid #000;"><?php if(in_array($rs_roc_group_product['id_group_product'],$roc_group_func)){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?>
		...
		<tr>
			<td style="padding:0.5% 0 2.5% 3%;font-size:0.9em;border-right:1px solid #000;">
				...
				?>
						<td style="width:45%; padding:0.8% 0 0 3%;font-size:0.9em;"><?php if(in_array($rs_roc_function['id_roc_func'],$roc_func)){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?><?echo $style_func.$rs_roc_function['title'].$style_end_func?></td>
					<?php if($i_function % 2 == 0){?></tr><?php } //display end row?>
					<?php if($num==$max_row){  ?>
					<tr>
						<td style="width:45%; padding:0.5% 0 0 3%;font-size:0.9em;">						
							<?php 
							if($rs_roc_group_product['id_group_product']==1){
								if(in_array('0',$roc_func)){
									echo '<img src="img/tick.png" style="width:15px;">';
									$style_other_func='<span style="color:#0079FC;">';
									$style_end_other_func='</span>';							
									echo $style_other_func.'อื่น ๆ (โปรดระบุ)'.$style_end_other_func;
									if($roc_other_func[$j]==''){echo '........................';}
									else{echo '&nbsp;'.$style_other_func.$roc_other_func[$j].$style_end_other_func;}
								}else{
									$style_other_func='';
									$style_end_other_func='';
									echo '<input type="checkbox">อื่น ๆ (โปรดระบุ)';
									if($roc_other_func[$j]==''){echo '........................';}
									else{echo '&nbsp;'.$style_other_func.$roc_other_func[$j].$style_end_other_func;}
								}
							}elseif($rs_roc_group_product['id_group_product']==2){
								if(in_array('-1',$roc_func)){
									echo '<img src="img/tick.png" style="width:15px;">';
									$style_other_func='<span style="color:#0079FC;">';
									$style_end_other_func='</span>';							
									echo $style_other_func.'อื่น ๆ (โปรดระบุ)'.$style_end_other_func;
							...
							}elseif($rs_roc_group_product['id_group_product']==3){
								if(in_array('-2',$roc_func)){
									echo '<img src="img/tick.png" style="width:15px;">';
									$style_other_func='<span style="color:#0079FC;">';
									$style_end_other_func='</span>';							
									echo $style_other_func.'อื่น ๆ (โปรดระบุ)'.$style_end_other_func;
							...
							}elseif($rs_roc_group_product['id_group_product']==4){
								if(in_array('-3',$roc_func)){
									echo '<img src="img/tick.png" style="width:15px;">';
									$style_other_func='<span style="color:#0079FC;">';
									$style_end_other_func='</span>';							
									echo $style_other_func.'อื่น ๆ (โปรดระบุ)'.$style_end_other_func;
				...
				?>
						<td style="width:45%; padding:0.8% 0 0 3%;font-size:0.9em;"><?php if(in_array($rs_roc_function['id_roc_func'],$roc_func)){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?><?echo $rs_roc_function['title']?></td>
	...
	<table style="width:100%;font-size:0.9em;text-align:left;border-left:1px solid #000;border-right:1px solid #000;" cellpadding="0" cellspacing="0">
		<tr>
			<td style="padding:1.5% 0 0 3%;"><?php if(in_array('-1',$roc_group_func)){echo '<img src="img/tick.png" style="width:15px;">';$style_other_g='<span style="color:#0079FC;">';$style_end_other_g='</span>';}else{$style_other_g='';$style_end_other_g='';?><input type="checkbox"><?php }echo $style_other_g;?>1.<?php echo $max_row_g2.'&nbsp;อื่น ๆ'; echo $style_end_other_g;?>
			<?php
	...
	<table style="width:100%;font-size:0.9em;text-align:left;<?php if($rs_product_app1['id_product_appearance']==1){?>border-left:1px solid #000;border-right:1px solid #000;<?}elseif($rs_product_app1['id_product_appearance']==2){?>border-left:1px solid #000;border-right:1px solid #000;border-bottom:1px solid #000;padding:0 0 20% 0;<?php }?>" cellpadding="0" cellspacing="0">
		...
		?>	
		<tr>
			<td style="padding:0.5% 0 0 3%;"><?php if($rs['id_product_appearance']==$rs_product_appearance['id_product_appearance']){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?><?php echo '&nbsp;'.$style_type_product.$rs_product_appearance['title_thai'].'('.$rs_product_appearance['title'].')'.$style_end_type_product;?>
				...
				<table style="width:100%;" cellpadding="0" cellspacing="0">
					...
					?>
						<td <?php if($rs_product_appearance['id_product_appearance']==1){if(($j_value==1) ||($j_value==3)){echo 'colspan="2"';}}elseif(($rs_product_appearance['id_product_appearance']==2) || ($rs_product_appearance['id_product_appearance']==3)){echo 'colspan="3"';}elseif($rs_product_appearance['id_product_appearance']==7){echo 'colspan="2"';}?> style="padding:1.0% 0 0 6.5%;">
							...
							<?php if(in_array($rs_roc_product_v['id_product_value'],$roc_product_value)){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?><?php echo $style_product_v.$rs_roc_product_v['title'].$style_end_product_v?>
							<?php }else{?>
							<?php if(in_array($rs_roc_product_v['id_product_value'],$roc_product_value)){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?><?php echo $style_product_v.$rs_roc_product_v['title'].$style_end_product_v?>
							<?php }?>
							<?php 
						...
						<td style="padding:1.0% 0 0 5.5%;">
							<?php if(in_array('0',$roc_product_value)){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?>
							<?php echo $style_product_v2;
				...
				<table style="width:100%;" cellpadding="0" cellspacing="0">
					...
					?>
						<td colspan="3" style="padding:1.0% 0 0 6.5%;">
							<?php if($rs['id_type_product_pack']==$rs_roc_product_p['id_type_product_pack']){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?>
							<?echo $style_product_v.$rs_roc_product_p['title_product_pack'].$style_end_product_v?>
							<?php 
						...
						if($rs_product_appearance['id_type_product']== 3){?>
							<?php if($rs['id_type_product_pack']==0){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?>
							อื่น ๆ (โปรดระบุ)
						<?php }
						}?>
					...
					?>
						<td <?php if(($j_w==0) || ($j_w==3)){?>style="padding:1.0% 0 0 6.5%;width:33.33%;"<?php }else{?>style="padding:1.0% 0 0 6.5%;width:33.33%;"<?php }?>>
							<?php if($rs['id_product_weight']==$rs_roc_product_w['id_product_weight']){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?>
							<?php echo $style_product_weight.$rs_roc_product_w['title'].$style_end_product_weight?>
						</td>
					...
					<?php if($num_w==$max_row_w){
						...
						<td style="padding:1.0% 0 0 6.5%;">
							<?php if($rs_product_appearance['id_product_appearance']==$rs['id_product_appearance']){if($rs['id_product_weight']== -1){echo '<img src="img/tick.png" style="width:15px;">';$weight_other='<span style="color:#0079FC;">';$weight_other_end='</span>';}}else{$weight_other='';$weight_other_end='';?><input type="checkbox"><?php }?>
							<?php echo $weight_other.'อื่น ๆ (โปรดระบุ)'.$weight_other_end?>
							<?php
							if(($rs['id_product_appearance']==$rs_product_appearance['id_product_appearance'])){
					...
					?>						
						<td <?php if($j_c == 1){?>colspan="2"<?php }else{?>style="padding:1.0% 0 0 6.5%;"<?php }?>>
							<?php if(in_array($rs_roc_product_c['id_type_product_color'],$roc_color)){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?>
							<?php echo $style_product_c.$rs_roc_product_c['type_product_color'].$style_end_product_c?>
							<?php 
					...
					<?php if($j_c % 2 == 0){?></tr><?php } //display row
						...
						?>
							<?php if($rs['id_product_appearance']==$rs_product_appearance['id_product_appearance']){if(in_array('0',$roc_color)){echo '<img src="img/tick.png" style="width:15px;">';}}else{?><input type="checkbox"><?php }?>
								อื่น ๆ (โปรดระบุ) <?php if($rs['id_product_appearance']==$rs_product_appearance['id_product_appearance']){if(in_array('0',$roc_color)){echo $roc_color_title[$i_title];}}else{echo '..................';}?>
					...
					<tr>
						...
						?>
							<td style="padding:1.5% 0 0 6.5%;">
								<?php if($rs_roc_product_p['id_type_product_pack']==$rs['id_type_product_pack']){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?>
								<?php echo $style_product_p.$rs_roc_product_p['title_product_pack'].$style_end_product_p?>
							</td>
	...
	elseif(($rs_product_app1['id_product_appearance'] >=3) && ($rs_product_app1['id_product_appearance'] <=6)){?>
		...
		<tr>
			<td style="padding:0.5% 0 0 3%;">
				<?php if($rs['id_product_appearance']==$rs_product_appearance['id_product_appearance']){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?>
			...
			<td>
				<table style="width:100%;" cellpadding="0" cellspacing="0">
					...
					?>
						...
						?>
						<td style="padding:1.0% 0 0 5.5%;">
							<?php if(in_array('0',$roc_product_value)){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?><?php echo $style_product_v2;
							echo 'ผงชงดื่มประเภทอื่น';
							echo '&nbsp;';
							echo '(โปรดระบุ)';
							echo $style_end_product_v2;
				...
				<table style="width:100%;" cellpadding="0" cellspacing="0">
					...
					?>
						<td colspan="3" style="padding:1.0% 0 0 6.5%;">
							<?php if($rs['id_type_product_pack']==$rs_roc_product_p['id_type_product_pack']){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?><?echo $style_product_v.$rs_roc_product_p['title_product_pack'].$style_end_product_v?>
							<?php 
							if(($rs_product_appearance['id_product_appearance']==6) || ($rs_product_appearance['id_product_appearance']==7)){
								if(($rs_roc_product_p['title']== 'สี (Color)') ||($rs_roc_product_p['title']=='กลิ่น (Odor)') || ($rs_roc_product_p['title']=='รูปร่าง (Shape)') || ($rs_roc_product_p['title']=='สี') || ($rs_roc_product_p['title']=='กลิ่น')){
									echo '(โปรดระบุ) ';
						...
						<?php if($num_p==$max_row_p){
						if($rs_product_appearance['id_type_product']== 3){?>
							<?php if($rs['id_type_product_pack']==0){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?>อื่น ๆ (โปรดระบุ)
						<?php }
						}?>
					<?php }//end while product pack?>
					<?php }//end if capsule and soft gel?>
					...
					?>
						<td style="<?php if($rs_product_appearance['id_product_appearance']!=4){?>width:35%;padding:1.0% 0 0 6.5%;<?php }else{?>width:15%;padding:1.0% 0 0 6.5%;<?php }?>">
							<?php if($rs['id_product_weight']==$rs_roc_product_w['id_product_weight']){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?><?php echo $style_product_weight.$rs_roc_product_w['title'].$style_end_product_weight?>
						</td>
					<?php if($j_w % 3 == 0){?></tr><?php } //display end row?>					
					<?php $j_w++;
						$num_w++;
					...
					?>						
						<td style="padding:1.0% 0 0 6.5%;">
							<?php if(in_array($rs_roc_product_c['id_type_product_color'],$roc_color)){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?><?php echo $style_product_c.$rs_roc_product_c['type_product_color'].$style_end_product_c?>
							<?php 
							if(($rs_product_appearance['id_product_appearance']==1) || ($rs_product_appearance['id_product_appearance']==3)){
								if(($rs_roc_product_c['type_product_color']== 'สี (Color)') ||($rs_roc_product_c['type_product_color']=='กลิ่น (Odor)') || ($rs_roc_product_c['type_product_color']=='รูปร่าง (Shape)') || ($rs_roc_product_c['type_product_color']=='สี') || ($rs_roc_product_c['type_product_color']=='กลิ่น')){
					...
					<?php if($j_c % 2 == 0){?></tr><?php } //display row
						...
						?>
								<?php if($rs['id_product_appearance']==$rs_product_appearance['id_product_appearance']){if(in_array('0',$roc_color)){echo '<img src="img/tick.png" style="width:15px;">';}}else{?><input type="checkbox"><?php }?>
								<?php if($rs['id_product_appearance']==$rs_product_appearance['id_product_appearance']){if(in_array('0',$roc_color)){echo $roc_color_title[$i_title];}}else{echo '..................';}?>
						<?php  } // not equal soft gelatin capsule
						}
						$j_c++;
						$num_c++;	
					...
					<tr>
						...
						?>
							<td style="padding:1.5% 0 0 6.5%;">
								<?php if($rs_roc_product_p['id_type_product_pack']==$rs['id_type_product_pack']){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?><?php echo $style_product_p.$rs_roc_product_p['title_product_pack'].$style_end_product_p?>
							</td>
						<?php if($j_p2 % 3== 0){?></tr><?php } //display row ?>						
						<?php
							$j_p2++;
					...
					<tr>
						<td style="padding:1.5% 0 0 3.5%;" colspan="7">
						<?php if($rs['id_product_appearance']== -1){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?>
						<?php echo '&nbsp;อื่น ๆ';?>
						<?php 
			...
			<td>
				...
				<table style="width:100%;" cellpadding="0" cellspacing="0">
					...
					<?php if($num_w==$max_row_w){
						if(($rs_product_appearance['id_product_appearance']==2) || ($rs_product_appearance['id_product_appearance']==4) || ($rs_product_appearance['id_product_appearance']==5)){echo '<tr>';}?>
						<td style="padding:1.0% 0 0 6.5%;">
							<?php if($rs['id_product_appearance']==$rs_product_appearance['id_product_appearance']){if($rs['id_product_weight']== -1){echo '<img src="img/tick.png" style="width:15px;">';}}else{?><input type="checkbox"><?php }?>อื่น ๆ (โปรดระบุ)
							<?php
							if($rs['other_product_weight']==''){echo '............';}
							else{
								if($rs['id_product_appearance']==$rs_product_appearance['id_product_appearance']){
					...
					<?php if($j_c % 2 == 0){?></tr><?php } //display row
						if($num_c==$max_row_c){$i_title++;
							if($rs_type_product['id_type_product']!=3){
								...
								if($rs_product_appearance['id_product_appearance']==3){$i_title=2;}
						?>
								<?php if($rs['id_product_appearance']==$rs_product_appearance['id_product_appearance']){if(in_array('0',$roc_color)){echo '<img src="img/tick.png" style="width:15px;">';}}else{?><input type="checkbox"><?php }?>อื่น ๆ (โปรดระบุ) <?php if($rs['id_product_appearance']==$rs_product_appearance['id_product_appearance']){if(in_array('0',$roc_color)){echo $roc_color_title[$i_title];}}else{echo '..................';}?>
						<?php  } // not equal soft gelatin capsule
						}
						$j_c++;
						$num_c++;	
	...
	<table style="width:100%;font-size:0.9em;padding:0 0 17% 0;margin:0;border-left:1px solid #000;border-right:1px solid #000;border-bottom:1px solid #000;" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td style="padding:1.5% 0 0 3.5%;">
				<?php if($rs_relation_pack['id_product_appearance']=='1,2,3'){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?>
				<?php
				$i_app=0;
		...
		<tr>
			<td>
				<table style="width:100%;" cellpadding="0" cellspacing="0">
					...
					?>
						<tr>
							<td colspan="4" style="padding:1.5% 0 0 5.5%;"><?php if($rs_relation_pack['id_type_package']==$rs_type_packaging['id_type_package']){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?>
							<?php echo $style_type_package1.$rs_type_packaging['title_thai'].$style_end_type_package1?>
							</td>
						</tr>
						<tr>
							...
							?>
								<td style="padding:1% 0 0 7.5%;">
									<?php if($rs_relation_pack['id_pack_size']==$rs_box_size['id_box_size']){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?><?php echo $style_pack_size1.$rs_box_size['title_box_size'].$style_end_pack_size1?>
								</td>
							<?php if($i_box % 3 == 0){?></tr><?php } //display row ?>
							<?php if($num_box_size==$max_row_box_size){?>
								<?php if($rs_type_packaging['id_type_package']==1){?><tr><?php }?>
								<td style="padding:1% 0 0 7.5%;">
								<?php if($rs_relation_pack['id_type_package']==$rs_type_packaging['id_type_package']){if($rs_relation_pack['id_pack_size']== -1){echo '<img src="img/tick.png" style="width:15px;">';$other_box_size='<span style="color:#0079FC;">';$other_box_size_end='</span>';}}else{$other_box_size='';$other_box_size_end='';?><input type="checkbox"><?php }?>
								<?php echo $other_box_size.'อื่น ๆ (โปรดระบุ)'.$other_box_size_end?>
								<?php
								if($rs_relation_pack['other_pack']==''){echo '......................';}
								else{echo $other_box_size.$rs_relation_pack['other_pack'].$other_box_size_end;}
								?>
								</td>
								<?php if($rs_type_packaging['id_type_package']==1){?></tr><?php }?>
							<?php }?>
							...
							?>
								<td style="padding:1% 0 0 7.5%;">
									<?php if(in_array($rs_foil['id_product_foil'],$roc_foil)){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?><?php echo $style_product_foil1.$rs_foil['title_foil'].$style_end_product_foil1?>
								</td>
							...
							?>
								<td style="padding:1% 0 0 7.5%;">
									<?php if($rs_relation_pack['id_product_bottle']==$rs_bottle['id_product_bottle']){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?><?php echo $style_product_bottle1.$rs_bottle['title_bottle'].$style_end_product_bottle1?>
								</td>
							...
							?>	
								<td style="padding:1% 0 0 7.5%;">
									<?php if(in_array($rs_materials['id_materials'],$roc_materials)){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?><?php echo $style_materials1.$rs_materials['title_materials'].$style_end_materials1?>
									<?php if($rs_materials['title_materials']=='ขนาดกล่อง'){
									$box_detail=split(",",$rs_relation_pack['box_detail']);
									?>
									<?php 
									if($rs_relation_pack['id_type_package']==$rs_type_packaging['id_type_package']){
										if(in_array('4',$roc_materials)){echo $style_materials1.$box_detail[0].$style_end_materials1;}
										elseif(in_array('10',$roc_materials)){echo $style_materials1.$box_detail[1].$style_end_materials1;}	
									}else{echo '..................';}
									?> 
									<?php $i_box_ma++;}//end if box size?>
								</td>
							...
							<tr>
								<td style="padding:1% 0 0 7.5%;">
								<?php if(in_array('-1',$roc_materials)){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?>
								<?php 
									echo $style_materials1.'อื่น ๆ'.$style_end_materials1;
									if($rs_relation_pack['other_materials']==''){echo '......................';}
									else{echo $style_materials1.'&nbsp;'.$rs_relation_pack['other_materials'].$style_end_materials1;}
								?>
								</td>
							</tr>
							<?php }
		...
		<tr>
			<td>
				<table style="width:100%;" cellpadding="0" cellspacing="0">
					...
					?>
					<tr>
						<td colspan="3" style="padding:1.5% 0 0 3.0%;"><?php if($rs_relation_pack['id_product_appearance']==$rs_product_appearance['id_product_appearance']){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?><?php echo '&nbsp;'.$style_relation_pack.$rs_product_appearance['title_thai'].'('.$rs_product_appearance['title'].')'.$style_end_relation_pack?>
						</td>
					</tr>
					<tr>
					...
					?>
						<td style="padding:1% 0 0 5.5%;">
							<?php if($rs_relation_pack['id_pack_size']==$rs_box_size['id_box_size']){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?><?php echo $style_pack_size.$rs_box_size['title_box_size'].$style_end_pack_size?>
						</td>
						<?php if($num_box_size==$max_row_box_size){?>
						<td style="padding:1% 0 0 5.5%;">
						<input type="checkbox">อื่น ๆ........<?php }?>
					...
					?>
						<td style="padding:1% 0 0 5.5%;">
							<?php if($rs_relation_pack['id_product_sachet']==$rs_sachet['id_product_sachet']){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?><?php echo $style_product_sachet.$rs_sachet['title_sachet'].$style_end_product_sachet?>
						</td>
						<?php if($num_sachet==$max_row_sachet){?>
						<td style="padding:1% 0 0 5.5%;"><?php if($rs_relation_pack['id_product_appearance']==$rs_product_appearance['id_product_appearance']){if($rs_relation_pack['id_product_sachet']== '-1'){echo '<img src="img/tick.png" style="width:15px;">';}}else{?><input type="checkbox"><?php }?>						
						อื่น ๆ
						<?php 						
					...
					?>
						<td style="padding:1% 0 0 5.5%;">
							<?php if($rs_relation_pack['id_product_foil']==$rs_foil['id_product_foil']){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?><?php echo $style_product_foil.$rs_foil['title_foil'].$style_end_product_foil?>
						</td>
					...
					?>
						<td style="padding:1% 0 0 5.5%;">
							<?php if($rs_relation_pack['id_type_bottle']==$rs_bottle['id_type_bottle']){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?><?php echo $style_type_bottle.$rs_bottle['title_type_bottle'].$style_end_type_bottle?>
						</td>
					...
					?>
						<td style="padding:1% 0 0 5.5%;">
							<?php if($rs_relation_pack['id_bottle_lid']==$rs_lid['id_bottle_lid']){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?><?php echo $style_bottle_lid.$rs_lid['title_bottle_lid'].$style_end_bottle_lid?>
						</td>
					...
					?>
						<td style="padding:0.5% 0 0 5.5%;">
							<?php if(in_array($rs_materials['id_materials'],$roc_materials)){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?><?php echo $style_materials.$rs_materials['title_materials'].$style_end_materials?>
							<?php if($rs_materials['title_materials']=='ขนาดกล่อง'){
							$box_detail=split(",",$rs_relation_pack['box_detail']);
							?>
					...
					<tr>
						<td colspan="3" style="padding:1% 0 0 5.5%;"><?php if(in_array($rs_materials['id_materials'],$roc_materials)){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?>อื่น ๆ
					...
					<?php }elseif(($rs_product_appearance['id_product_appearance']==4) || ($rs_product_appearance['id_product_appearance']==6)){?>
						<td style="padding:1% 0 0 5.5%;"><?php if(in_array($rs_materials['id_materials'],$roc_materials)){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?>อื่น ๆ
						<?php if($rs_product_appearance['id_product_appearance']==$rs_relation_pack['id_product_appearance']){
							if($rs_relation_pack['other_materials'] != ''){
								echo '<span style="color:#0079FC;">'.$rs_relation_pack['other_materials'].'</span>';
							}else{echo '........';}
			...
			<td>
				<table style="width:100%;" cellpadding="0" cellspacing="0">
					<tr>
						...
						?>
						<td colspan="4" style="padding:1% 0 0 5.5%;"><?php if($rs['id_ink_jet']==1){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?><?php echo '&nbsp;'.$style_ink1.'Ink Jet'.$style_end_ink1?></td>
					</tr>
					<?php 
					$i_ink=0;
					...
					?>
					<tr>
						<td style="width:290px;padding:1% 0 0 7.5%;"><?php if(in_array($rs_ink['id_ink_jet'],$type_ink)){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?><?php echo $style_ink.$rs_ink['title_ink_jet'].$style_end_ink?></td>
						<?php
						$j_ink_detail=0;
						...
						while($rs_ink_detail=mysql_fetch_array($res_ink_detail)){
							...
							if($j_ink_detail==1){								
						?>
							<td style="width:200px;padding:1% 0 0 10%;vertical-align:top;"><?php if(in_array($rs_ink_detail['id_detail_ink'],$detail_ink)){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?><?php echo $style_ink_detail.$rs_ink_detail['title_detail_ink'].$style_end_ink_detail?></td>
						<?php }else{?>
						<tr>
							<td style="width:290px;"></td>
							<td style="width:200px;padding:1% 0 0 10%;"><?php if(in_array($rs_ink_detail['id_detail_ink'],$detail_ink)){echo '<img src="img/tick.png" style="width:15px;">';}else{?><input type="checkbox"><?php }?><?php echo $style_ink_detail.$rs_ink_detail['title_detail_ink'].$style_end_ink_detail?></td>
						</tr>
						<?php }										
