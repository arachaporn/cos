			...
			<form name="frmMain" action="del-costing-table.php" method="post">
				<table style="border: 0; width: 100%;" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td class="b-bottom" style="text-align:left;"><div class="large-4 columns"><h4>ประวัติอุปกรณ์</h4></div></td>
					</tr>
					<tr>
						<td colspan="2" style="background:#fff;">
							<div class="large-4 columns">
								...
								?>
									<a href='show-record-device.php?device=<?php echo $rs_device['id_type_device']?>'>
									<div class="btn-home">
