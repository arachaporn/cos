...
<body>
	...
	$sql .=" group by id_employee order by id_sd_device desc LIMIT $Page_Start , $Per_Page";
	$res = mysql_query($sql) or die ('Error '.$sql);
	?>
	<div class="row">
		...
		<table style="border: 0; width: 100%;" cellpadding="0" cellspacing="0">
			<tr>
				<td class="b-bottom" style="text-align:left;">
					<div class="large-4 columns"><a href="register-device.php"><?php echo '< ทะเบียนอุปกรณ์'?></a></div>	
				</td>
				<?php
				...
				?>
				<td class="b-bottom"><div class="large-4 columns"><h4>ทะเบียนอุปกรณ์ <?php echo $rs_device['title_device']?></h4></div></td>
			</tr>
			<tr>
					...
					<div class="large-4 columns">
						<table style="border: 1 solid #eee; width: 100%;" cellpadding="0" cellspacing="0">
							...
							<tr>
								...
								<td class="center"><a class='various' data-fancybox-type='iframe' href='show-detail.php?device=<?=$rs['id_type_device']?>&account=<?=$rs_account2['id_employee']?>'>รายละเอียด</a></td>
							</tr>
							<?php } ?>
						</table>
					</div>
