...
$strExcelFileName="CR Sales Forecast ".$month_name." ".$year.".xls";
...
<table x:str border=1 cellpadding=2 cellspacing=1 width=100% style="border-collapse:collapse">
	<tr>
		<td colspan="2" height="80" width="100" style="border-right:none;"><img src="http://cdipthailand.com/cos/img/logo.png" width="100"></td>
		<td colspan="8" style="text-align:center;vertical-align:middle;font-size:20px;border-left:none;"><?php echo $po='CR forecast <span style="color:red">'.$month_name.'</span>&nbsp;'.$year;?></td>
	</tr>
	<tr>
		<td colspan="10" style="text-align:center;font-size:20px;font-weight:bold;">Vat</td>
	</tr>
</table>
</div>
<?php
	...
	if($i !=0){?>
		...
		<table x:str border=1 cellpadding=0 cellspacing=1 width=100% style="border-collapse:collapse">
			<tr>
				...
				<td style="text-align:center;vertical-align:middle;">ปิด Lot</td>
				<td style="text-align:center;vertical-align:middle;">Total Grand</td>
			...
			<table style="width:100%;" border=1 cellpadding="0" cellspacing="0">
				...
				?>
				<tr>
					<td style="text-align:center;"><?php if($pm != 27){echo substr($rs_acc2['username'],2);}else{echo $rs_acc2['username'];}?></td>
					<td></td>
					<td></td>
					<td></td>
					<td></td>
			...
			<table style="width:100%;" border=1 cellpadding="0" cellspacing="0">
				...
				<td style="vertical-align:top;"><?php echo $rs['po_no']?></td>
				...
				<td style="text-align:right;vertical-align:top;"><?php echo $style_red;echo number_format($rs['close_lot'],2);echo $style_end_red;?></td>		
				<td style="text-align:right;vertical-align:top;"><?php echo $style_red;echo number_format($rs['total_grand'],2);echo $style_end_red;?></td>		
			...
			<table style="width:100%;" cellpadding="0" cellspacing="0">
				<tr>
					<td colspan="9" style="text-align:right;"><?php $sum_reject=$total-$reject;echo '<span style="text-decoration:underline;">'.number_format($sum_reject,2).'</span>'?></td>
				</tr>
			</table>
		<?php }//end if?>
	<?php }//end if i?>	
...
<table style="width:100%;" border=1 cellpadding="0" cellspacing="0">		
	...
	<tr>
		<td colspan="8" style="text-align:right;">Vat7%</td>
		<td style="text-align:right;"><?php $vat=$sum_reject2*0.07;echo number_format($vat,2)?></td>
	</tr>
	<tr>
...
<table style="width:100%;" cellpadding="0" cellspacing="0">	
	...
	<tr>
		...
		<td style="text-align:right;"><?php echo number_format($rs_target['sales_target'],2)?></td>
		<td style="text-align:left;">บาท</td>
	</tr>
	<tr>
		<td colspan="2" style="text-align:left;">เปอร์เซ็นต์จากเป้า</td>	
		<td style="text-align:right;"><?php $persent=(($grand_total*100)/$rs_target['sales_target']);echo number_format($persent,2)?></td>
		<td style="text-align:left;">%</td>
	</tr>
	<tr>
		<td colspan="2" style="text-align:left;">ยอดต่าง</td>	
		<td style="text-align:right;"><?php $total_diff=$rs_target['sales_target']-$grand_total;echo number_format($total_diff,2)?></td>
		<td style="text-align:left;">บาท</td>
	</tr>
</table><br><br><br><br>
<table style="width:100%;" cellpadding="0" cellspacing="0">		
