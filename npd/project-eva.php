	...
	<div class="row">
		...
		<table style="border: 0; width: 100%;" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td class="b-bottom"><div class="large-4 columns"><h4>Project Evaluation</h4></div></td>
					...
					<div class="large-4 columns">
						<table style="border: 1 solid #eee; width: 100%;" cellpadding="0" cellspacing="0">
							<tr class="top">
								...
								<td width="3%">No.</td>
								<td width="15%">Roc code</td>
								<td width="10%">Project evaluation</td>
								<td width="10%" class="center">Type product</td>
								<td width="8%" class="center">PDF Evaluation</td>
								<td width="8%" class="center">PDF NPD Costing</td>
								<td width="8%" class="center">Create by</td>
							...
							<tr>
								...
								<td class="center"><a href="pdf-project-eva.php?id_u=<?php echo $rs_npd_eva['id_project_eva']?>" target=_blank><img src="img/icon-pdf.png" width="28px"></a></td>
								<td class="center"><a href="pdf-costing.php?id_u=<?php echo $rs_npd_eva['id_project_eva']?>" target=_blank><img src="img/icon-pdf.png" width="28px"></a></td>
								<td class="center">
									<?php
									$sql_emp="select * from account where id_account='".$rs['create_by']."'";
								...
								<td class="center"><?php if($rs_npd_eva['project_status']==0){echo 'On Process';}elseif($rs_npd_eva['project_status']==1){echo 'Complete';}?></td>
							</tr>
							<?php } ?>
