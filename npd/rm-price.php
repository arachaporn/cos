...
<body>
	...
	$sql .=" order  by id_npd_rm desc LIMIT $Page_Start , $Per_Page";
	$res = mysql_query($sql) or die ('Error '.$sql);
	?>
	<div class="row">
						...
						<div class="large-4 columns">
							<table style="border: 1 solid #eee; width: 100%;" cellpadding="0" cellspacing="0">
								<tr class="top">
									...
									<td width="30%" class="center">Supplier</td>
									<td width="10%" class="center">Price/kg</td>
								</tr>
								<?php
								$i=0;
								...
								<tr>
									...
									<td class="center"><input type="checkbox" name="ck_del[]" id="ck_del<?php echo $i?>" value="<?php echo $rs['id_npd_rm'];?>"></td>
									<td class="center"><?php echo $i;?></td>
									<td><?php echo $rs['npd_rm_code'];?></td>
									<td><a href="ac-rm-price.php?id_u=<?php echo $rs['id_npd_rm']?>"><?php echo $rs['npd_rm_name'];?></a></td>
									<td class="center"><?php echo $rs['npd_supplier']?></td>
									<td class="center"><?php echo $rs['npd_rm_price'];?></td>
								</tr>
								<?php } ?>
