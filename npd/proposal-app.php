...
<body>
	...
	$sql="select * from npd_inno_proposal";
	$sql.= $where;
	...
	$sql .=" order by id_proposal desc LIMIT $Page_Start , $Per_Page";
	$res = mysql_query($sql) or die ('Error '.$sql);
	?>
	<div class="row">
		...
		<table style="border: 0; width: 100%;" cellpadding="0" cellspacing="0">
			<tr>
				<td class="b-bottom" style="text-align:left;">
					<div class="large-4 columns"><a href="../npd.php"><?php echo '< New Prodcut Development'?></a></div>	
				</td>
				<td class="b-bottom"><div class="large-4 columns"><h4>Proposal Application</h4></div></td>
				<td class="b-bottom" style="text-align:right;">
					<div class="large-4 columns">
						<input type="button" value="Create" class="btn-new" onclick="window.location.href='ac-proposal-app.php?id_u=New&p=1'" title="New">
					...
					<div class="large-4 columns">
						<table style="border: 1 solid #eee; width: 100%;" cellpadding="0" cellspacing="0">
							...
							<tr>
								...
								<td class="center"><input type="checkbox" name="ck_del[]" id="ck_del<?php echo $i?>" value="<?php echo $rs['id_proposal'];?>"></td>
								<td><?php echo $i;?></td>
								<td><a href="ac-proposal-app.php?id_u=<?php echo $rs['id_proposal']?>&p=1"><?php echo $rs['proposal_no'];?></td>
								<td><?php echo $rs['name_th_proposal'];?></td>
