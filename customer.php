	...
	<div class="row">
		...
		<table style="border: 0; width: 100%;" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td class="b-bottom"><div class="large-4 columns"><h4>Customer</h4></div></td>
			...
			<tr>
				<td colspan='3'>
					<div class="large-4 columns">
						<?php
						$sql_com_cat="select count(id_com_cat) as sum_id from company_category";
						$res_com_cat=mysql_query($sql_com_cat) or die ('Error '.$sql_com_cat);
						$rs_com_cat=mysql_fetch_array($res_com_cat);
						?>
						<div id="bg-sub-menu"><span class="left"><a href="company-cate.php">Company Category</a></span><span class="right"><a href="company-cate.php"><?php echo $rs_com_cat['sum_id']?></a></span></div>
					</div>
				</td>
			</tr>
			<?php } ?>
