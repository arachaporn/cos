...
<table x:str border=1 cellpadding=0 cellspacing=1 width=100% style="border-collapse:collapse">
	<tr>
		...
		<td colspan="7" style="vertical-align:middle;text-align:center;font-size:20px;border-left:none;"><?php echo $po='Sales forecast <span style="color:red">'.$month_name.'</span>&nbsp;'.$year;?></td>
	</tr>
	<tr>
		<td colspan="9" style="text-align:center;font-size:20px;font-weight:bold;">Vat</td>
	</tr>
</table>
</div>
<?php
	...
	if($i !=0){?>
		...
		<table x:str border=1 cellpadding=0 cellspacing=1 width=100% style="border-collapse:collapse">
			<tr>
				...
				<td style="text-align:center;vertical-align:middle;">PO. No.</td>
				<td style="text-align:center;vertical-align:middle;">Product</td>
				<td style="text-align:center;vertical-align:middle;">Quantities<br>(Unit)</td>
				<td style="text-align:center;vertical-align:middle;">Price per<br>Unit (Baht)</td>
			...
			<table style="width:100%;" border=1 cellpadding="0" cellspacing="0">
				...
				?>
				<tr>
					<td style="text-align:center;"><?php if($i==7){echo 'N/A';}elseif($pm != 27){echo substr($rs_acc2['username'],2);}else{echo $rs_acc2['username'];}?></td>
					<td></td>
					<td></td>
					<td></td>
					<td></td>
				...
				<tr>
					<td colspan="7"></td>
					<td style="text-align:right;"><?php echo '<span style="text-decoration:underline;border-bottom: 1px solid #000;">'.number_format($sum_reject,2).'</span>'?></td>
				</tr>
			</table>
			<?php 
			}else{
			...
			<table style="width:100%;" border=1 cellpadding="0" cellspacing="0">
				<tr>
					...
					<td style="vertical-align:top;"><?php echo $rs['date_visited'].'/'.$rs['month_visited'].'/'.$rs['year_visited']?></td>
					...
					<td style="text-align:right;vertical-align:top;"><?php echo $rs['po_no']?></td>
					<td style="vertical-align:top;"><?php echo $style_red.$rs['pre_production'].$style_end_red;?>
					</td>
					<td style="text-align:right;vertical-align:top;"><?php echo $style_red;echo number_format($rs['quantities'],2);echo $style_end_red;?></td>	<td style="text-align:right;vertical-align:top;"><?php echo $style_red;echo number_format($rs['price_per_baht'],2);echo $style_end_red;?></td>
					<td style="text-align:right;vertical-align:top;"><?php echo $style_red;echo number_format($rs['total'],2);echo $style_end_red;?></td>
					<td style="vertical-align:top;"><?php echo $style_red;echo $rs['note'];echo $style_end_red;?></td>	
				</tr>		
			</table>
			<?php }//end while?>
			<table style="width:100%;" cellpadding="0" cellspacing="0">
				<tr>
					<td colspan="8" style="text-align:right;"><?php $sum_reject=$total-$reject;echo '<span style="text-decoration:underline;border-bottom: 1px solid #000;">'.number_format($sum_reject,2).'</span>'?></td>
				</tr>
			</table>			
		<?php }//end if?>
		</div>
...
<table style="width:100%;" cellpadding="0" cellspacing="0">	
	...
	$sql_target .=" and year_visited='".$year."' and type_target='balance'";
